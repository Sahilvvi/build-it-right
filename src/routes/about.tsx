    ...
    <SiteLayout>
      ...
      <section className="relative overflow-hidden bg-[hsl(220_50%_9%)] py-24 text-primary-foreground md:py-32">
        ...
        <div className="container-px relative mx-auto max-w-7xl">
          ...
          <motion.div layout className="mx-auto mt-12 grid max-w-3xl gap-5">
            {team.filter((m) => m.cat === "Leadership").map((m, i) => (
              <motion.div
                ...
                className="group relative flex items-center gap-5 overflow-hidden rounded-2xl border border-white/10 bg-white/[0.04] p-5 backdrop-blur-md transition-all hover:border-accent/40 hover:bg-white/[0.08]"
              >
                <div className={cn("relative h-20 w-20 shrink-0 overflow-hidden rounded-2xl bg-gradient-to-br", m.tone)}>
                  <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_20%,rgba(255,255,255,0.25),transparent_60%)]" />
                ...
                <a href="#" aria-label="LinkedIn" className="grid h-9 w-9 shrink-0 place-items-center rounded-full bg-white/10 text-white/70 transition-colors hover:bg-accent hover:text-accent-foreground">
