    ...
    topics: [
      {
        ...
        weight: "6–9%",
        body: "Core quantitative tools and techniques for financial analysis and informed investment decisions — descriptive statistics, probability, and risk.",
      },
      {
        name: "Economics",
        weight: "6–9%",
        body: "Micro and macro foundations: supply and demand, market structures, monetary and fiscal policy, currency exchange rate dynamics.",
      },
      {
        name: "Alternative Investments",
        weight: "7–10%",
        body: "Hedge funds, private equity, real estate, infrastructure, commodities — their risk-return characteristics.",
      },
      {
        name: "Corporate Issuers",
        weight: "6–9%",
        body: "Corporate governance, capital structure, cost of capital, working capital and business models.",
      },
      {
        name: "Financial Statement Analysis",
        weight: "11–14%",
        body: "Reading and interpreting financial statements under IFRS and US GAAP — ratios, quality of earnings.",
      },
      {
        name: "Equity Investments",
        weight: "11–14%",
        body: "Equity markets, valuation techniques, industry and company analysis.",
      },
      {
        name: "Fixed Income",
        weight: "11–14%",
        body: "Bond markets, yield curves, credit risk, securitization and term-structure models.",
      },
      {
        name: "Derivatives",
        weight: "5–8%",
        body: "Forwards, futures, options and swaps — pricing, hedging and applications.",
      },
      {
        name: "Portfolio Management",
        weight: "8–12%",
        body: "Portfolio construction, modern portfolio theory, risk management and the investment policy statement.",
      },
      {
        name: "Ethical & Professional Standards",
        weight: "15–20%",
        body: "CFA® Institute Code & Standards — applied to real-world scenarios that every charterholder faces.",
      },
    ],
  },
  "Level II": {
    ...
    topics: [
      {
        ...
        weight: "10–15%",
        body: "Deep valuation models — DDM, FCFE, residual income, market-based multiples.",
      },
      {
        name: "Fixed Income",
        weight: "10–15%",
        body: "Term structure models, credit analysis, structured products.",
      },
      {
        name: "Derivatives",
        weight: "5–10%",
        body: "Pricing models, option strategies, swaps and credit derivatives.",
      },
      {
        name: "Alternative Investments",
        weight: "5–10%",
        body: "Private equity, real estate, hedge funds — valuation and due diligence.",
      },
      {
        name: "Portfolio Management",
        weight: "10–15%",
        body: "Asset allocation, risk modelling, behavioural finance.",
      },
      {
        name: "Corporate Issuers",
        weight: "5–10%",
        body: "Capital budgeting, M&A and corporate restructuring.",
      },
      {
        name: "Financial Statement Analysis",
        weight: "10–15%",
        body: "Intercorporate investments, pensions, multinationals.",
      },
      { name: "Economics", weight: "5–10%", body: "Currency, growth and economic regulation." },
      {
        name: "Quantitative Methods",
        weight: "5–10%",
        body: "Regression, time-series and machine learning intros.",
      },
      {
        name: "Ethical & Professional Standards",
        weight: "10–15%",
        body: "Applied ethics across cases and disciplinary scenarios.",
      },
    ],
  },
  "Level III": {
    ...
    topics: [
      {
        name: "Portfolio Management",
        weight: "35–40%",
        body: "Asset allocation, currency risk, fixed income & equity portfolio management.",
      },
      {
        name: "Asset Allocation",
        weight: "15–20%",
        body: "Strategic allocation, risk budgeting, factor-based investing.",
      },
      {
        name: "Fixed Income Portfolios",
        weight: "15–20%",
        body: "Liability-driven investing, immunization, multi-asset strategies.",
      },
      {
        name: "Equity Portfolio Management",
        weight: "10–15%",
        body: "Active and passive equity strategies, factor models.",
      },
      {
        name: "Derivatives & Risk Management",
        weight: "5–10%",
        body: "Using derivatives to manage portfolio risk.",
      },
      {
        name: "Ethical & Professional Standards",
        weight: "10–15%",
        body: "GIPS standards plus applied ethics for senior practitioners.",
      },
    ],
  },
} as const;
  ...
  "Pre-recorded": [
    {
      tier: "CFA® Level 1",
      price: "₹20,000",
      note: "140+ hours · Recorded lectures",
      popular: true,
    },
    {
      tier: "Level 2 Pre-recorded",
      price: "₹25,000",
      note: "80+ hours · Recorded lectures",
      popular: false,
    },
    {
      tier: "Level 3 Pre-recorded",
      price: "₹25,000",
      note: "60+ hours · Recorded lectures",
      popular: false,
    },
    {
      tier: "Financial Modelling",
      price: "₹20,000",
      note: "Pre-recorded programme · Full project walkthrough",
      popular: false,
    },
  ],
} as const;
...
function HeroFact({ icon: Icon, title, body }: { icon: ElementType; title: string; body: string }) {
  return (
        ...
        <div className="flex gap-7 overflow-x-auto py-4 text-sm font-semibold no-scrollbar">
          {CHAPTER_NAV.map((c) => {
            ...
            return (
              ...
              >
                <span
                  className={isActive ? "text-primary" : "text-foreground/55 hover:text-foreground"}
                >
                  {c.label}
                </span>
                {isActive && (
    ...
    <section id="about" className="relative overflow-hidden scroll-mt-32 py-24 md:py-32">
      ...
      <div className="container-px relative mx-auto max-w-7xl">
        ...
        <p className="mt-6 max-w-3xl text-base leading-relaxed text-muted-foreground md:text-lg">
          The Chartered Financial Analyst (CFA®)® designation is a globally recognized credential in
          investment management. Awarded by CFA® Institute, it develops skills in valuation,
          portfolio management, and ethics. Earning the Charter requires passing three exams (Levels
          I–III) and meeting qualifying work requirements.
        </p>
    ...
    <section id="level-1" className="relative overflow-hidden scroll-mt-32 py-24 md:py-32">
      ...
      <div className="container-px relative mx-auto max-w-7xl">
        ...
        <p className="mt-5 max-w-3xl text-base leading-relaxed text-muted-foreground md:text-lg">
          Three exams — Levels I, II, and III — build from core tools to asset valuation and,
          finally, portfolio management and ethics. Syllabus evolves; weights may change by exam
          cycle. Always check CFA® Institute.
        </p>

        {/* Premium gradient-bordered level tabs */}
        <div
          id={level === "Level II" ? "level-2" : level === "Level III" ? "level-3" : undefined}
          className="mt-10"
        >
          <motion.div
          ...
          >
            <div className="mt-8 grid gap-4 sm:grid-cols-3">
              {[
                ...
                <div
                  key={k}
                  className="group relative overflow-hidden rounded-2xl border border-border bg-card px-5 py-5 shadow-soft transition-all hover:border-accent/40 hover:shadow-[0_18px_36px_-18px_hsl(var(--accent)/0.45)]"
                >
  ...
  const sections = [
    {
      letter: "A",
      title: "Exam Pattern",
      body: "Two 135-minute sessions of multiple-choice questions covering all 10 topics. Computer-based, delivered at Prometric centres globally.",
    },
    {
      letter: "B",
      title: "Exam Periods",
      body: "Three windows per year — February, May, August, and November (subject to level).",
    },
    {
      letter: "C",
      title: "Registration Fee",
      body: "Early: $940 · Standard: $1,290 per level. Coaching fees are shared on enquiry.",
    },
  ];
          ...
          <div className="relative grid gap-6 rounded-[calc(2rem-1px)] bg-navy-gradient p-8 text-primary-foreground md:grid-cols-[1.5fr_1fr] md:items-center md:p-10">
            ...
            <div>
              ...
              <p className="mt-3 text-white/75">
                See how our mentors, doubt-solving, and mock exams shape your prep — and keep you on
                track.
              </p>
            </div>
            <a
...
function Pricing() {
  ...
  return (
    <section
      id="pricing"
      className="relative overflow-hidden bg-secondary/40 scroll-mt-32 py-24 md:py-32"
    >
      ...
      <div className="container-px relative mx-auto max-w-7xl">
        ...
        <p className="mt-5 max-w-2xl text-base text-muted-foreground">
          Single-level packs to jump in, or combo bundles for the full Charter journey — built for
          serious learners.
        </p>
            ...
            {plans.map((p, i) => (
              ...
              >
                ...
                >
                  ...
                  <h3
                    className={
                      "mt-2 font-display text-2xl font-semibold " + (p.popular ? "text-white" : "")
                    }
                  >
                    {p.tier}
                  </h3>
                  <div
                    className={
                      ...
                      (p.popular ? "text-white" : "text-primary")
                    }
                  >
                    {p.price}
                  </div>
                  {p.note && (
                    <div
                      className={
                        "mt-2 text-sm " + (p.popular ? "text-white/70" : "text-muted-foreground")
                      }
                    >
                      {p.note}
                    </div>
                  ...
                  <ul
                    className={
                      ...
                      (p.popular ? "text-white/85" : "text-foreground/80")
                    }
                  >
      ...
      <div className="container-px relative mx-auto grid max-w-7xl gap-12 lg:grid-cols-[1fr_1.1fr] lg:items-center">
        <div>
          ...
          <p className="mt-5 max-w-md text-base text-white/70">
            A 20-minute, no-pressure call to map your goal and the fastest route to your CFA®
            Charter.
          </p>
                ...
                <div className="relative overflow-hidden rounded-2xl p-[1px]">
                  ...
                  >
                    ...
                    <div className="min-w-0">
                      ...
                      <div className="mt-1 font-display text-base font-semibold md:text-lg">
                        {f.q}
                      </div>
