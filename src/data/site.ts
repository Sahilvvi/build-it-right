...
export const courses: Course[] = [
  {
    ...
    category: "cfa",
    duration: "Classroom + Pre-recorded · Weekday & Weekend batches",
    level: "Beginner",
    format: "Hybrid",
    price: "₹36,000 classroom / ₹20,000 pre-recorded",
    rating: 4.9,
    learners: 900,
    badge: "Most popular",
    outcomes: [
    ...
    highlights: [
      "Curriculum Questions solved in class",
      "Batch size capped at 35 students for focused learning",
      "Handwritten notes + pre-recorded lectures in the LMS",
  ...
  },
  {
    ...
    level: "Intermediate",
    format: "Hybrid",
    price: "₹40,000 classroom / ₹25,000 pre-recorded",
    rating: 4.9,
    learners: 420,
    outcomes: [
...
export const faqs = [
  ...
  {
    q: "How many hours of study do I need to dedicate weekly for CFA?",
    a: "25+ hours of effective study i.e. 3-4 hours per day in the initial days. 8-10 hours per day around a month and a half before exams.",
  },
  {
